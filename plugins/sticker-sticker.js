...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*[❗معلومة❗] يستجيب لمقطع فيديو أو صورة أو يدرج صورة نهائية ويضمنها. jpg وسيتم تحويله إلى ملصق، ثم قم بالرد أو استخدم الأمر ${usedPrefix + command}*`;
      let out;
      try {
    ...
    else throw '*فـيـن الـصـوره او الـفـيـديـو لـي بـدك تـخـلـيـه مـلـصـق!!*';
  }
};
handler.help = ['sfull'];
